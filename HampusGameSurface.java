...
public class GameSurface extends JPanel implements ActionListener, KeyListener {
    ...
    public GameSurface(final int width, final int height) {
        ...
        this.spaceShip = new Rectangle(80, width / 2 - 15, 30, 20);
    ...
    private void addAlien(final int width, final int height) {
        int x = 250;
        int y = 100;
        aliens.add(new Rectangle(380, 250, 30, 150));
        aliens.add(new Rectangle(380, 0, 30, 150));
    }
    ...
    private void repaint(Graphics g) {
        ...
        if (spaceShip.y < (this.getSize().height - spaceShip.height - 10)){
